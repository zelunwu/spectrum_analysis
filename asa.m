function [apsd,freq] = asa(ts,dt,M_seg,option)
%-------------------------------------------------------------------------%
% Function:
% [apsd,freq] = ASA(ts,dt,M_seg,option)
...
[Xf_seg_matrix,freq] = dft(ts_seg_matrix,dt,option); % Discrete Fourier Transform of ts segment matrix. if M_seg>1, the outour Xf will be a N_seg*M_seg matrix.
%-------------------------------------------------------------------------%
